...
@Component({
  selector: 'elpis-rms-grid-layout4',
  templateUrl: './grid-layout4.component.html',
  styleUrls: ['./grid-layout4.component.scss']
})
export class GridLayout4Component implements OnInit {
  @Input() devicedata;
  ...
  console.log(bgColor,fontColor,"colors checking");
    ...
    let dialogRef = this.dialog.open(CardStyleLayoutFivePopup,
      {
        width:'900px',
        height:'535px',
...
@Component({
  selector: 'card-style-layout-five-popup',
  templateUrl: './card-style-layout-five-popup.html',
  styleUrls: ['./grid-layout4.component.scss']
})
export class CardStyleLayoutFivePopup implements OnInit {

  constructor(public dialogRef: MatDialogRef<CardStyleLayoutFivePopup>,
