...
@Component({
  selector: 'elpis-rms-grid-layout1',
  templateUrl: './grid-layout1.component.html',
  styleUrls: ['./grid-layout1.component.scss']
})
export class GridLayout1Component implements OnInit {
  @Input() devicedata;
  ...
  ngOnInit(): void {
    ...
    console.log(bgColor,fontColor,"colors checking");
      ...
      let dialogRef = this.dialog.open(CardStyleLayoutTwoPopup,
        {
          width:'900px',
          height:'535px',
...
@Component({
  selector: 'card-style-layout-two-popup',
  templateUrl: './card-style-layout-two-popup.html',
  styleUrls: ['./grid-layout1.component.scss']
})
export class CardStyleLayoutTwoPopup implements OnInit {

  constructor(public dialogRef: MatDialogRef<CardStyleLayoutTwoPopup>,
