...
@Component({
  selector: 'elpis-rms-grid-layout2',
  templateUrl: './grid-layout2.component.html',
  styleUrls: ['./grid-layout2.component.scss']
})
export class GridLayout2Component implements OnInit {
  @Input() devicedata;
  ...
  ngOnInit(): void {
    ...
    console.log(bgColor,fontColor,"colors checking");
      ...
      let dialogRef = this.dialog.open(CardStyleLayoutThreePopup,
        {
          width:'900px',
          height:'535px',
...
@Component({
  selector: 'card-style-layout-three-popup',
  templateUrl: './card-style-layout-three-popup.html',
  styleUrls: ['./grid-layout2.component.scss']
})
export class CardStyleLayoutThreePopup implements OnInit {

  constructor(public dialogRef: MatDialogRef<CardStyleLayoutThreePopup>,
