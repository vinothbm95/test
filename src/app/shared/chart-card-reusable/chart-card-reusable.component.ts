...
@Component({
  selector: 'elpis-rms-chart-card-reusable',
  templateUrl: './chart-card-reusable.component.html',
  styleUrls: ['./chart-card-reusable.component.scss']
})
export class ChartCardReusableComponent implements OnInit {
  @Input() devicedata;
  ...
  console.log(bgColor,fontColor,"colors checking");
    ...
    let dialogRef = this.dialog.open(CardStyleLayoutOnePopup,
      {
        width:'900px',
        height:'538px',
...
@Component({
  selector: 'card-style-layout-one-popup',
  templateUrl: './card-style-layout-one-popup.html',
  styleUrls: ['./chart-card-reusable.component.scss']
})
export class CardStyleLayoutOnePopup implements OnInit {

  constructor(public dialogRef: MatDialogRef<CardStyleLayoutOnePopup>,
